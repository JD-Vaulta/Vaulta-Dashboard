...
const BatteryRegistrationPage = () => {
  ...
  const [currentStep, setCurrentStep] = useState(hasRegisteredBatteries ? 'form' : 'welcome');
      ...
      >
        <div style={cardStyle}>
          ...
          <p style={{ color: '#666', fontSize: '18px', lineHeight: '1.6', marginBottom: '32px' }}>
            To get started, you'll need to register at least one battery. 
            This ensures you only see data from batteries you own and manage.
          </p>
          <div style={{ 
      ...
      >
        <div style={cardStyle}>
          ...
          <p style={{ color: '#666', fontSize: '18px', marginBottom: '32px' }}>
            Your battery has been registered and you can now access all features of the system.
          </p>
